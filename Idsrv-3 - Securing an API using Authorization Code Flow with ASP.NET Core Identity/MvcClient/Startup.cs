        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddAuthentication(options =>
            {
                ...
                .AddOpenIdConnect("oidc", options =>
                {
                    ...
                    options.ClaimActions.MapUniqueJsonKey("role", "role"); // role claim was associated with 'roles' scope

                    options.TokenValidationParameters = new TokenValidationParameters()
                    {
                        RoleClaimType = "role" // stating where our framework can find the user’s role when we are asking for role verification, like when we put [Authorize(Roles = "Admin")] on controller or controller action method.
                    };
                });
